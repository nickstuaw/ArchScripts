...
mount /dev/sda3 /mnt
# PACKAGES
pacstrap /mnt base base-devel linux-zen linux-firmware dhcpcd sudo vim git go ufw pipewire pipewire-alsa pipewire-jack pipewire-pulse xorg-server xorg-apps lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings nvidia kitty
