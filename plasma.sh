...
mount /dev/sda3 /mnt
# PACKAGES
pacstrap /mnt base base-devel linux-zen linux-firmware dhcpcd sudo vim git go ufw pipewire pipewire-alsa pipewire-jack pipewire-pulse gtk3 lightdm xorg xorg-server xorg-apps lightdm-gtk-greeter nvidia kitty
