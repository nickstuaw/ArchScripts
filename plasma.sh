...
mount /dev/sda3 /mnt
# PACKAGES
pacstrap /mnt base base-devel linux-zen linux-firmware nvidia dhcpcd sudo vim git go ufw pipewire pipewire-alsa pipewire-jack pipewire-pulse xorg-server xorg-apps gtk3 lightdm lightdm-gtk-greeter kitty
