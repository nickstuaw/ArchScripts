...
mount /dev/sda3 /mnt
# PACKAGES
pacstrap /mnt base linux-zen linux-firmware dhcpcd sudo vim git ufw pipewire pipewire-alsa pipewire-jack pipewire-pulse xorg-server xorg-apps gtk3 lightdm lightdm-gtk-greeter nvidia kitty
