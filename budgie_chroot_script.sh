...
echo -n "Set the password for $uname." && passwd $uname
...
# Set the wallpaper
su -c "gsettings set org.gnome.desktop.background picture-uri file:///usr/share/backgrounds/budgie/default.jpg" $uname
