...
# PACKAGES
pacstrap /mnt base linux-zen linux-firmware dhcpcd sudo vim ufw nvidia pipewire pipewire-alsa pipewire-jack pipewire-pulse xorg-server xorg-apps gdm gnome-desktop budgie-desktop budgie-screensaver gnome kitty
